 ...
 * specified {@link OnGatepassListFragmentInteractionListener}.
...
public class MyGatepassRecyclerViewAdapter extends RecyclerView.Adapter<MyGatepassRecyclerViewAdapter.ViewHolder> {
    ...
    private final GatepassFragment.OnGatepassListFragmentInteractionListener mListener;

    public MyGatepassRecyclerViewAdapter(List<DummyItem> items, OnGatepassListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_gatepass, parent, false);
